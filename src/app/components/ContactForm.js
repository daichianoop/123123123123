          ...
          <form className={""} onSubmit={handleSubmit}>
            ...
            <div className={"text-neutral-400 text-sm font-bold md:text-md lg:text-md xl:text-md"}>
              <label htmlFor={"message"} className={"pl-2"}>
                Message <br/>
                <textarea className={"w-72 rounded-sm border-black border-2 text-black text-sm md:text-md lg:text-md xl:text-md px-2 bg-neutral-200"} name={"message"} rows={10} placeholder={"Enter your message"} id={"message"}
                value={user.message}
                onChange={handleChange}
                autoComplete={"off"}
                required/>
            ...
            <div className={"flex items-center justify-center "}>
              <button className={"shadow-white shadow-2xl bg-red-800 w-52 mt-2 py-1 px-2 text-sm hover:bg-red-900 active:translate-y-0.5 border-black border "} type={"submit"}>Send Message</button>
            </div>
          </form>
        </div>
      </>
